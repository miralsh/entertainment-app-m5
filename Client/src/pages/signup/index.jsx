        ...
        <div className="flex flex-col lg:mx-auto items-center px-6">
            ...
            <div className="flex flex-col  bg-[#161D2F] rounded-xl py-4 px-6 mx-12 ">
                ...
                <form className="flex flex-col items-center">
                    ...
                    <input placeholder="Repeat password" type="password" className="text-sm w-75 focus:outline-hidden px-2 py-2 my-2 placeholder-[#87898E] border-b-2 border-b-[#5A698F] text-white focus:caret-[#FC4747] focus:border-b-white"  />
                    <button className="text-sm w-75 bg-[#FC4747] text-white rounded my-4 py-2 hover:bg-white hover:text-black">Create an account</button>
                </form>
                <p className="my-2 text-white text-sm text-center">Already have an account? <span className="mx-2 text-[#FC4747]">Login</span></p>
            </div>
        </div>
        </div>
    )
