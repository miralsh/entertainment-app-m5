        ...
        <nav aria-label="Main navigation" className="sticky top-0 z-50 w-full border-b border-white/10 bg-[#0B0B0D]/95 px-3 shadow-lg shadow-black/30 backdrop-blur-md">
            <div className="mx-auto grid h-16 max-w-[1600px] grid-cols-[1fr_auto_1fr] items-center gap-2 md:h-[4.75rem] md:px-5">
                ...
                <div className="flex min-w-0 items-center justify-center gap-2 overflow-x-auto py-2 sm:gap-4 md:gap-8">
                    <Link to="/" aria-label="Home" className={`inline-flex shrink-0 items-center gap-2 border-b-2 px-2 py-2 text-sm font-medium transition hover:border-[#E50914] hover:text-white focus:outline-none focus:ring-2 focus:ring-[#E50914] ${activeP == 'Home' ? 'border-[#E50914] text-white' : 'border-transparent text-[#B3B3B3]'}`} onClick={() => onSelect('Home')}><RiLayoutGridFill size={20} /><span className="hidden md:inline">Home</span></Link>
                    <Link to="/movies" aria-label="Movies" className={`inline-flex shrink-0 items-center gap-2 border-b-2 px-2 py-2 text-sm font-medium transition hover:border-[#E50914] hover:text-white focus:outline-none focus:ring-2 focus:ring-[#E50914] ${activeP == 'Movie' ? 'border-[#E50914] text-white' : 'border-transparent text-[#B3B3B3]'}`} onClick={() => onSelect('Movie')}><RiFilmFill size={20} /><span className="hidden md:inline">Movies</span></Link>
                    <Link to="/tvseries" aria-label="TV series" className={`inline-flex shrink-0 items-center gap-2 border-b-2 px-2 py-2 text-sm font-medium transition hover:border-[#E50914] hover:text-white focus:outline-none focus:ring-2 focus:ring-[#E50914] ${activeP == 'Tv' ? 'border-[#E50914] text-white' : 'border-transparent text-[#B3B3B3]'}`} onClick={() => onSelect('Tv')}><TbDeviceTvOld size={20} /><span className="hidden md:inline">TV Series</span></Link>
                    <button type="button" aria-label="Bookmarks" className={`inline-flex shrink-0 items-center gap-2 border-b-2 px-2 py-2 text-sm font-medium transition hover:border-[#E50914] hover:text-white focus:outline-none focus:ring-2 focus:ring-[#E50914] ${activeP == 'Bookmark' ? 'border-[#E50914] text-white' : 'border-transparent text-[#B3B3B3]'}`} onClick={() => onSelect('Bookmark')}><RiBookmarkFill size={20} /><span className="hidden md:inline">My List</span></button>
                </div>
